...
import lim.jiyeon.hb88chnhthc.databinding.ActivityYeonJinActsBinding
import java.util.*
import kotlin.math.abs

class YeonJinActs : AppCompatActivity() {

    private lateinit var binding: ActivityYeonJinActsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityYeonJinActsBinding.inflate(layoutInflater)
        ...
        if (savedInstanceState != null) {
            ...
            mWebView?.loadUrl("file:///android_asset/pair-game/dist/index.html?lang=" + Locale.getDefault().language)
        }
